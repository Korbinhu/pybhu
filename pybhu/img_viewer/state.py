...
class ViewerState:
    ...
    def _calculate_limits(self) -> tuple[float, float]:
        """Calculates min and max dynamically from the actual data of the current layer."""
        layer = self.data[:, :, self.current_layer]
